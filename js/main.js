...
(() => {
    ...
    n.n = t => {
        ...
        const he = document.querySelector(".custom-generator__avatar canvas"),
            ...
            ve = ["/assets/parts/background/common/Bg 4.png", "/assets/parts/background/rare/Bg 1.png", "/assets/parts/background/rare/Bg 2.png", "/assets/parts/background/rare/Bg 3.png"],
            be = ["/assets/parts/body/common/Original.png"],
            we = ["#", "/assets/parts/clothes/common/Bip.png", "/assets/parts/clothes/common/Cape.png", "/assets/parts/clothes/common/Icy sweater.png", "/assets/parts/clothes/common/Naruto jacket.png", "/assets/parts/clothes/common/Ponco.png", "/assets/parts/clothes/common/Shirt.png", "/assets/parts/clothes/rare/Jacket.png", "/assets/parts/clothes/rare/Medal.png", "/assets/parts/clothes/rare/Tuxedo.png", "/assets/parts/clothes/super rare/Duck float.png", "/assets/parts/clothes/super rare/Wings.png"],
            xe = ["/assets/parts/eyes/common/Original.png", "/assets/parts/eyes/common/Big eyes.png", "/assets/parts/eyes/common/Sus.png", "/assets/parts/eyes/common/Weird.png", "/assets/parts/eyes/common/Xx.png", "/assets/parts/eyes/rare/Pixel.png"],
            ke = ["#", "/assets/parts/head/common/Cap.png", "/assets/parts/head/common/Headband.png", "/assets/parts/head/common/Mafia.png", "/assets/parts/head/rare/Afro.png", "/assets/parts/head/rare/Arrow.png", "/assets/parts/head/rare/Egg.png", "/assets/parts/head/rare/Goggles.png", "/assets/parts/head/rare/Russian hat.png", "/assets/parts/head/super rare/Horns.png", "/assets/parts/head/super rare/Mohawk.png"],
